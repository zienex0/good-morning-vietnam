...
class BudgetingTopUpPage extends ConsumerStatefulWidget {
  const BudgetingTopUpPage({super.key});

  @override
  ConsumerState<BudgetingTopUpPage> createState() => BudgetingTopUpPageState();
}
...
class BudgetingTopUpPageState extends ConsumerState<BudgetingTopUpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (accounts.isEmpty || tripId == null) {
      return const BudgetingTransactionEmptyShell(title: 'Top up');
    }
        ...
        child: FilledButton(
          ...
          child: Text(
            formatBudgetingPrimaryAction(
              action: formState.isLoading ? 'Saving...' : 'Add',
